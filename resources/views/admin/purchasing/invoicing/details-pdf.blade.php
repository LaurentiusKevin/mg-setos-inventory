...
<main>
    <table style="width: 100%">
        <tr>
            <td class="text-bold" style="width: 40%; font-size: 8px; color: indianred;">Info Penggunaan</td>
            <td class="text-bold" style="width: 20%; font-size: 8px; color: indianred;"></td>
            <td class="text-bold" style="width: 40%; font-size: 8px; color: indianred;">Catatan</td>
        </tr>
        <tr>
            <td>
    ...
    <table class="table-transaksi">
        ...
        @foreach($product AS $key => $item)
            <tr>
                ...
                <td class="font-weight-bold text-nowrap">{{ $item->product_code }}</td>
                ...
                <td class="text-nowrap">{{ date('d F Y, H:i:s',strtotime($item->invoicing_created_at)) }}</td>
            </tr>
        ...
        <tr style="background-color: rgba(205,92,92,0.47)">
            ...
            <td class="text-center text-bold" colspan="2"></td>
        </tr>
        </tbody>
    </table>
</main>
