...
@section('title','Master Data - Supplier - Edit')
                ...
                <form id="formData">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <a href="{{ url("admin/master-data/supplier/api/get-image/{$data->logo}") }}" data-fancybox data-caption="{{ $data->name }}">
                                <img src="{{ url("admin/master-data/supplier/api/get-image/{$data->logo}") }}" alt="" style="width: 75px" />
                            </a>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer bg-gradient-secondary">
                        <div class="row justify-content-between">
                            <div class="col-sm-12 col-md-4 col-lg-2">
                                <a href="{{ route('admin.master-data.supplier.view.index') }}" class="btn btn-block btn-outline-primary"><i class="fas fa-arrow-left mr-2"></i>Kembali</a>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-2">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        FilePond.setOptions({
            ...
            allowMultiple: false,
            server: {
                url: '{{ route('admin.master-data.supplier.api.upload-image') }}',
                process: {
                    method: 'post',
                    headers: {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            document.getElementById('formData').addEventListener('submit', event => {
                ...
                if (image_upload_process === true) {
                    ...
                    axios({
                        url: '{{ route('admin.master-data.supplier.api.store') }}',
                        method: 'post',
                        data: {
                            id: id(),
                            name: name(),
