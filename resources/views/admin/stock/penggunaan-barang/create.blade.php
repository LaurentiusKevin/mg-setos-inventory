...
@section('title','Stock - Penggunaan Barang - Create')
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="i_info_penggunaan" class="font-weight-bold">Info Penggunaan</label>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        const t_list_product = $('#t_list_product').DataTable({
            ...
            scrollX: true,
            ajax: {
                url: '{{ route('admin.stock.penggunaan-barang.api.product-list') }}',
                method: 'post',
                data: function (d) {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            list_penggunaan_produk_tbody.on( 'keyup', 'input.input-quantity', function (event) {
                let data = list_penggunaan_produk_data($(event.target).parents('tr'));

                let data_id = parseInt($(this).attr('data-id'));

                let quantity = data_cleave.input_quantity[data_id].getRawValue();

                let quantity_left = data.stock;
            ...
            document.getElementById('form-data').addEventListener('submit', event => {
                ...
                axios({
                    url: '{{ route('admin.stock.penggunaan-barang.api.store') }}',
                    method: 'post',
                    data: {
