    ...
    public function exportExcel(Request $request)
    {
        ...
        try {
            ...
            foreach ($summary AS $item) {
                ...
                $sheet->getStyle("E:E")->getNumberFormat()->setFormatCode('_("Rp"* #,##0.00_);_("Rp"* \(#,##0.00\);_("Rp"* "-"??_);_(@_)');
                $sheet->getStyle("G")->getNumberFormat()->setFormatCode('dd/mm/yyyy hh:mm:ss');
                ...
                $sheet->getStyle("A1:G1")->applyFromArray(StylePhpSpreadsheetHelper::tHead());
                $sheet->getStyle("A2:G{$startRow}")->applyFromArray(StylePhpSpreadsheetHelper::tBody());
                $sheet->getStyle("A{$startRow}:G{$startRow}")->applyFromArray(StylePhpSpreadsheetHelper::bold());
            }
